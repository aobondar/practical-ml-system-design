...
|                                  | Percentage of fully automated dialogues                        | ✅Good (some dialogs are easier to automate than others)           | ⚠️OK (via A/B testing, though it might be affected by behavior differences in users with/without the bot, affected by different conversion rates on different intents) | ✅Good (automatically generated, but time for data collection is needed) | 🔥Great     | 🔥Yes             |
