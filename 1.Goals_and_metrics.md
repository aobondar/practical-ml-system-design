...
|----------------------------------|---------------------------------------------------------|-------------|--------------------------------------------------------------------|----------------------------------------------------------------|-----------|-----------------|
| Increase level of automation     | Diff in cost per customer for groups with and without the bot | 🔥🔥Excellent   | ✅Good (via A/B testing, though it might be affected by behavior differences in users with/without the bot) | ⚠️OK (some people receive a degraded service, data collection takes time) | 🔥Great     | 🔥Yes             |
|                                  | Diff in operator's time per customer for groups with and without the bot | 🔥Great (excellent if all operators are paid equally)               | 🔥Great (via A/B testing, though it might be affected by behavior differences in users with/without the bot) | ⚠️OK (some people receive a degraded service, data collection takes time) | 🔥Great     | 🔥Yes             |
