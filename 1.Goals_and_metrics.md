...
In reality it's impossible to have metric, which mets all these criterias. So practical step here is to have proxy, which sacrifies some of the properties. +system of ballanced metrics+
