...
As you can see, there is no ideal set of metrics in real-world applications. A good news is that, you have a handy heuristic: at the early stages of the system, when you have a limited understanding of the domain and the solution is unpolished, any adequate metric will point you in the right direction. In practice, this means:
