...
* **Mix honeypots (gold standards) into annotation tasks to aproximately calculate metric relibility** <TODO: add confidence interval calculations for different sizes of honeypots sets>
