...
* Timespent
* Visits / retention
* Acceptance rates for co-pilots
...
* A model is a part of biger pipeline, so you want to track quality of NLP model (like in chatbot scenario you may want to track the quality of intent classification separately from other business logic around it)
...
The trickiest part of making a good annotation based metric is it's consistency and sensitivity.
